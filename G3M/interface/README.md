...
The bottom bar is the quickest way to understand what G3M is doing right now.

- the text explains the current state
- the progress bar appears during longer tasks
- the main button changes based on context

Depending on the situation, that main button can become:
...
So if you are ever unsure what the launcher expects from you, look there first.
